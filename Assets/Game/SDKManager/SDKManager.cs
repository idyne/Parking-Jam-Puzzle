...
public class SDKManager : MonoBehaviour
{
    ...
    private const string BannerAdUnitId = "6d1f89ad9984e356";
    private const string InterstitialAdUnitId = "2ac76762f38b4e99";
    private const string RewardedAdUnitId = "42643fe4567654f9";
    ...
    private void OnEnable()
    {
        ...
        Debug.Log("SOMEBODY CALSS MEEE!!!!");
        
        Debug.Log("SMALL TRIAL!");
    }
